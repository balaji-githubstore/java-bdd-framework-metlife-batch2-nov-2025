...
public class EmployeeSteps {
    ...
    public void user_click_on_save_employee() {
    ...
    @Then("User should get the firstname field as {string}")
    public void user_should_get_the_firstname_field_as(String expectedFirstName) {
